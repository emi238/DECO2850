...
const styles = StyleSheet.create({
  ...
  word: { fontFamily: fonts.display, fontSize: 28, color: colors.text },
  paw: { width: 50, height: 50, tintColor: colors.orangeDeep },
  title: { fontFamily: fonts.bold, fontSize: 36, color: colors.orangeDeep, textAlign: 'center', marginTop: 28 },
  subtitle: { fontFamily: fonts.regular, fontSize: 17, color: colors.text, textAlign: 'center', lineHeight: 24, marginTop: 12, paddingHorizontal: 20 },
  panel: { flex: 1, backgroundColor: colors.bg, borderTopLeftRadius: 30, borderTopRightRadius: 30 },
  // Fills the panel: fields span the width and the form is spread down the page.
  body: { flexGrow: 1, paddingHorizontal: 28, paddingTop: 36, paddingBottom: 24 },
  footer: { alignItems: 'center', paddingTop: 12, paddingBottom: 16 },
  footerTxt: { fontFamily: fonts.regular, fontSize: 16, color: '#8A8580' },
...
export const authStyles = StyleSheet.create({
  ...
  input: { height: 52, borderRadius: 12, fontSize: 17, paddingHorizontal: 16 },
  submit: { marginTop: 28, height: 54 },
  submitTxt: { fontFamily: fonts.semibold, color: colors.bg, fontSize: 18 },
  note: { fontFamily: fonts.regular, fontSize: 14, color: '#8A8580', textAlign: 'center', marginTop: 18, lineHeight: 20 },
  avatar: { width: 84, height: 84, alignSelf: 'center', marginBottom: 32 },
  forgot: { fontFamily: fonts.medium, fontSize: 15, color: colors.orangeDeep },
});
